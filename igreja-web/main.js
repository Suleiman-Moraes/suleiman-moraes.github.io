...
/***/ "ZFNV":
/*!*************************************************************!*\
  !*** ./src/app/pages/pages-shared/services/menu.service.ts ***!
  \*************************************************************/
...
class MenuService extends src_app_shared_components_base_resource_service_base_resource_service__WEBPACK_IMPORTED_MODULE_2__["BaseResourceService"] {
    constructor(injector) {
        super(`${src_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].API_URL}/api/menu`, injector);
        this.injector = injector;
        this.route = `${src_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].API_URL}/api/menu`;
    }
    findBy() {
        return this.http.get(`${this.route}/ativo`).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["map"])((res) => res), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["catchError"])(this.handleError));
    }
}
MenuService.ɵfac = function MenuService_Factory(t) { return new (t || MenuService)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_angular_core__WEBPACK_IMPORTED_MODULE_0__["Injector"])); };
...
AvatarComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: AvatarComponent, selectors: [["app-avatar"]], features: [_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵInheritDefinitionFeature"]], decls: 8, vars: 2, consts: [["align", "center", 2, "background-color", "var(--primary-color)"], ["href", "#/pages", 1, "navbar-brand"], ["src", "assets/img/esperanca.png", "width", "150", "loading", "lazy", 1, "p-mr-2"], [2, "color", "var(--primary-color-text) !important"]], template: function AvatarComponent_Template(rf, ctx) { if (rf & 1) {
    ...
    } }, styles: ["\n/*# sourceMappingURL=data:application/json;base64, */"] });
...
/* harmony import */ var _avatar_avatar_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../avatar/avatar.component */ "gi6I");
/* harmony import */ var _side_bar_item_side_bar_item_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../side-bar-item/side-bar-item.component */ "wKXa");
...
class SideBarComponent extends src_app_shared_components_base_resource_util_base_resource_util_component__WEBPACK_IMPORTED_MODULE_1__["BaseResourceUtilComponent"] {
...
SideBarComponent.ɵfac = function SideBarComponent_Factory(t) { return new (t || SideBarComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_core__WEBPACK_IMPORTED_MODULE_0__["Injector"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](src_app_pages_pages_shared_services_menu_service__WEBPACK_IMPORTED_MODULE_2__["MenuService"])); };
SideBarComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: SideBarComponent, selectors: [["app-side-bar"]], features: [_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵInheritDefinitionFeature"]], decls: 2, vars: 1, consts: [[3, "menus"]], template: function SideBarComponent_Template(rf, ctx) { if (rf & 1) {
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](SideBarComponent, [{
    ...
    }], function () { return [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Injector"] }, { type: src_app_pages_pages_shared_services_menu_service__WEBPACK_IMPORTED_MODULE_2__["MenuService"] }]; }, null); })();
...
function SideBarItemComponent_div_4_div_7_Template(rf, ctx) { if (rf & 1) {
    const _r7 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵgetCurrentView"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 11);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function SideBarItemComponent_div_4_div_7_Template_div_click_0_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r7); const filho_r5 = ctx.$implicit; const ctx_r6 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](2); return ctx_r6.navegar(filho_r5.url); });
...
function SideBarItemComponent_div_4_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtemplate"](7, SideBarItemComponent_div_4_div_7_Template, 4, 3, "div", 10);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
} if (rf & 2) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](1);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵproperty"]("ngForOf", item_r2.itemMenus);
} }
function SideBarItemComponent_app_side_bar_item_5_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](0, "app-side-bar-item", 12);
} if (rf & 2) {
...
SideBarItemComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: SideBarItemComponent, selectors: [["app-side-bar-item"]], inputs: { menus: "menus" }, decls: 6, vars: 2, consts: [["align", "center", 1, "text-muted", "mt-2", 2, "cursor", "pointer", 3, "click"], [1, "pi", "pi-home"], ["id", "accordionExample", 1, "accordion"], ["class", "card", 4, "ngFor", "ngForOf"], [3, "item", 4, "ngFor", "ngForOf"], [1, "card"], ["id", "headingOne", 1, "card-header"], ["data-toggle", "collapse", 1, "mb-0", 3, "id", "click"], ["data-toggle", "collapse", 2, "float", "right"], ["aria-labelledby", "headingOne", "data-parent", "#accordionExample", 1, "collapse", 3, "id"], ["class", "card-body", 3, "click", 4, "ngFor", "ngForOf"], [1, "card-body", 3, "click"], [3, "item"]], template: function SideBarItemComponent_Template(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "h5", 0);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function SideBarItemComponent_Template_h5_click_0_listener() { return ctx.navegar("/pages/home"); });
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](1, "i", 1);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](2, " Home");
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](3, "div", 2);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtemplate"](4, SideBarItemComponent_div_4_Template, 8, 8, "div", 3);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtemplate"](5, SideBarItemComponent_app_side_bar_item_5_Template, 1, 1, "app-side-bar-item", 4);
    } if (rf & 2) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](4);
...
/***/ "yVcJ":
/*!**********************************************************************************!*\
  !*** ./src/app/shared/components/base-resource-service/base-resource.service.ts ***!
  \**********************************************************************************/
...
class BaseResourceService {
    ...
    getAll() {
        return this.http.get(this.apiPath).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])((res) => res), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["catchError"])(this.handleError));
    }
    getById(id) {
    ...
    getUtil(url) {
        return this.http.get(url).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])((res) => res), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["catchError"])(this.handleError));
    }
    imprimirUtilComBody(url, object) {
        return this.http.post(url, object).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])((res) => res), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["catchError"])(this.handleError));
    }
    create(resource) {
        return this.http.post(this.apiPath, resource).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])((res) => res), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["catchError"])(this.handleError));
    }
    update(resource) {
        return this.http.put(this.apiPath, resource).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])((res) => res), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["catchError"])(this.handleError));
    }
    delete(id) {
        return this.http.delete(`${this.apiPath}/${id}`).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])((res) => res), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["catchError"])(this.handleError));
    }
    enviarFormulario(resource, metodo) {
        return metodo ? this.update(resource) : this.create(resource);
    }
    findByPararamsFilter(filterForm) {
        return this.http.post(`${this.apiPath}/findbyparamssingle`, filterForm)
