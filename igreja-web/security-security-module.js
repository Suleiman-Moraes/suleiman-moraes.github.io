...
LoginComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: LoginComponent, selectors: [["app-login"]], features: [_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵInheritDefinitionFeature"]], decls: 21, vars: 2, consts: [[1, "fundo-login"], [1, "was-validated", 3, "formGroup", "submit"], [1, "form-row"], [1, "form-group", "col-md-3"], [1, "form-group", "col-md-6"], [1, "card", "vertical-center", 2, "background-image", "url('../../../../assets/img/cruz2.jpg')"], [1, "card-body"], [1, "form-group", "col-md-12"], ["for", "login", 2, "color", "black"], ["type", "text", "id", "login", "formControlName", "login", "placeholder", "Login", "title", "Login", "required", "", 1, "form-control"], ["for", "password", 2, "color", "black"], ["type", "password", "id", "password", "formControlName", "password", "placeholder", "Senha", "title", "Senha", "required", "", 1, "form-control"], ["align", "right", 1, "form-group", "col-md-12"], ["type", "submit", "title", "Entrar", 1, "btn", "btn-secondary", 3, "disabled"], [1, "pi", "pi-sign-in"]], template: function LoginComponent_Template(rf, ctx) { if (rf & 1) {
